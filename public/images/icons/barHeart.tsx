...
function BarHeart({color, isFav = "transparent", classes, width = 13, height = 14}: IHome) {
  return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill={isFav} xmlns="http://www.w3.org/2000/svg">
